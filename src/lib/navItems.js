import { LayoutDashboard, Radar, User, Sword, FlaskConical, Wrench, Store, Layers, Radio, LifeBuoy } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { to: '/market/resources', label: 'Resources', Icon: Layers },
