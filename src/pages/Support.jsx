  ...
  return (
    <div className="max-w-2xl mx-auto px-4 md:px-8 py-10 md:py-16">
      ...
      <div className="glass-panel rounded-2xl p-6 mb-6">
        ...
        <p className="text-sm text-muted-foreground font-body leading-relaxed">For Game Play Questions and Bug reporting. Please email kerbango@proton.me or join out
