...
import { Sword, FlaskConical, Wrench, Store, Handshake, Radio, LifeBuoy } from 'lucide-react';
    ...
    <Routes>
      ...
      <Route element={
        ...
        <Route element={<GameLayout />}>
          ...
          <Route path="/support" element={<SectionPlaceholder title="Support" Icon={LifeBuoy} />} />
        </Route>
