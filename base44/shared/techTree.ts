...
export const TECH_TREE = [
  ...
  { id: "basic_weapons", name: "Kinetic Cannons", description: "Mass-driver weapons for defense.", category: "Weapons", icon: "Crosshair", researchTurns: 1, prerequisites: [], tier: 1 },
  ...
  { id: "basic_ship", name: "Orbital Frames", description: "Modular hull frameworks for stations.", category: "Ship Technology", researchTurns: 1, prerequisites: [], tier: 1 },
  ...
  { id: "laser_weapons", name: "Laser Batteries", description: "Coherent-light point defense.", category: "Weapons", icon: "Sun", researchTurns: 2, prerequisites: ["basic_weapons"], tier: 2 },
  ...
  { id: "freighters", name: "Freighters", description: "Bulk cargo hulls.", category: "Ship Technology", researchTurns: 2, prerequisites: ["basic_propulsion"], tier: 2 },
  ...
  { id: "turbolasers", name: "Turbolasers", description: "Rapid-fire coherent beams.", category: "Weapons", icon: "Sun", researchTurns: 3, prerequisites: ["laser_weapons"], tier: 3 },
  ...
  { id: "plasma_weapons", name: "Plasma Focusing", description: "Confine plasma into lances.", category: "Weapons", icon: "Flame", researchTurns: 4, prerequisites: ["heavy_ion_beams"], tier: 4 },
  ...
  { id: "orbital_shipyards", name: "Orbital Shipyards", description: "Build ships in orbit.", category: "Ship Technology", researchTurns: 4, prerequisites: ["advanced_alloys", "ion_drive"], tier: 4 },
  ...
  { id: "battleship_hull", name: "Battleship Hull", description: "Capital warship frame.", category: "Ship Technology", researchTurns: 5, prerequisites: ["orbital_shipyards", "turbolasers"], tier: 5 },
  { id: "carrier_hull", name: "Carrier Hull", description: "Launch swarm craft.", category: "Ship Technology", researchTurns: 5, prerequisites: ["orbital_shipyards", "guided_missiles"], tier: 5 },
  ...
  { id: "titan_hull", name: "Titan Hull", description: "Vessels of immense scale.", category: "Ship Technology", researchTurns: 6, prerequisites: ["battleship_hull", "living_metal"], tier: 6 },
  ...
  { id: "titan_class", name: "Titan-Class Vessel", description: "The pinnacle warship.", category: "Ship Technology", researchTurns: 9, prerequisites: ["titan_hull", "death_ray"], tier: 7 },
