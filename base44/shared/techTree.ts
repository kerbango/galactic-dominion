...
export const TECH_TREE = [
  ...
  { id: "basic_ship", name: "Orbital Frames", description: "Modular hull frameworks for stations.", category: "Ship Technology", researchTurns: 1, prerequisites: [], tier: 1, isPrimary: true, unlocks: { units: ["scout_frigate"] }, unlockTags: ["ship", "ship_upgrade"] },
  ...
  { id: "freighters", name: "Freighters", description: "Bulk cargo hulls.", category: "Ship Technology", researchTurns: 2, prerequisites: ["basic_propulsion"], tier: 2, isPrimary: true, unlocks: { units: ["freighter"] }, unlockTags: ["ship", "ship_upgrade"] },
  ...
  { id: "battleship_hull", name: "Battleship Hull", description: "Capital warship frame.", category: "Ship Technology", researchTurns: 5, prerequisites: ["orbital_shipyards", "turbolasers"], tier: 5, isPrimary: true, unlocks: { units: ["battleship"], upgrades: ["reinforced_hull_ii"] }, unlockTags: ["ship", "empire_upgrade", "ship_upgrade"] },
  ...
  { id: "titan_hull", name: "Titan Hull", description: "Vessels of immense scale.", category: "Ship Technology", researchTurns: 6, prerequisites: ["battleship_hull", "living_metal"], tier: 6, isPrimary: true, unlocks: { units: ["titan"], upgrades: ["heavy_armor"] }, unlockTags: ["ship", "empire_upgrade", "ship_upgrade"] },
  ...
  { id: "titan_class", name: "Titan-Class Vessel", description: "The pinnacle warship.", category: "Ship Technology", researchTurns: 9, prerequisites: ["titan_hull", "death_ray"], tier: 7, isPrimary: true, unlocks: { units: ["titan_class_vessel"], weapons: ["spinal_mount_cannon"] }, unlockTags: ["ship", "ship_upgrade"] },
