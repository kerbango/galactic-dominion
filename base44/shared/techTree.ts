...
// Research nodes live here. Roman-numeral entries are permanent Upgrade Page
// purchases; actual units and buildings remain research unlocks.
...
export const TECH_TREE = [
  ...
  { id: "advanced_detection_grid", name: "Advanced Detection Grid", description: "Expands the empire's ability to detect concealed fleets before they reach engagement range.", category: "Defense", tier: 5, researchTurns: 5, prerequisites: ["ecm_detection_architecture"], unlocks: { upgrades: ["ECM Field Matrix I", "ECM Field Matrix II", "ECM Field Matrix III"] } },
  ...
  { id: "resource_extraction", name: "Advanced Resource Extraction", description: "Improves the empire's ability to extract strategic resources.", category: "Economy and Resources", tier: 2, researchTurns: 2, prerequisites: ["resource_administration"] },
  ...
  { id: "planetary_growth_economics", name: "Planetary Growth Economics", description: "Aligns population growth with long-term economic output.", category: "Economy and Resources", tier: 3, researchTurns: 3, prerequisites: ["industrial_expansion"], unlocks: { upgrades: ["Population Growth I"] } },
  ...
  { id: "quantum_computing", name: "Quantum Computing", description: "Advanced computation accelerates future research calculations.", category: "Fleet Research", tier: 3, researchTurns: 3, prerequisites: ["jump_drive_attunement"], unlocks: { abilities: ["research_speed"] } },
  ...
  { id: "carrier_architecture", name: "Carrier Architecture", description: "Develops dedicated carrier systems for fighters and drones.", category: "Fleet Research", tier: 4, researchTurns: 4, prerequisites: ["cruiser_hull"], isPrimary: true, unlocks: { units: ["carrier", "drone_carrier"] } },
  { id: "capital_hull_engineering", name: "Capital Hull Engineering", description: "Allows construction of battleship, battlecruiser and dreadnought-scale hulls.", category: "Fleet Research", tier: 5, researchTurns: 5, prerequisites: ["cruiser_hull"], isPrimary: true, unlocks: { units: ["battleship", "battlecruiser", "dreadnought"] } },
  { id: "fleet_command_network", name: "Fleet Command Network", description: "Links fleets and command ships into a coordinated battlespace network.", category: "Fleet Research", tier: 5, researchTurns: 5, prerequisites: ["quantum_computing", "capital_hull_engineering"] },
  ...
  { id: "relic_adhesion_matrix_ai", name: "Relic Adhesion Matrix AI", description: "A dangerous AI that reconstructs and integrates ancient technology. It is one half of the gate to Blacklisted Alien Technology.", category: "Exploration", tier: 6, researchTurns: 6, prerequisites: ["relic_matrices"], isPrimary: true, unlockTags: ["blacklisted_gate"] },
  ...
  { id: "standardized_empire_codes", name: "Standardized Empire Codes", description: "Creates common legal and administrative standards throughout the empire.", category: "Empire Governance", tier: 1, researchTurns: 1, prerequisites: [], isPrimary: true, unlocks: { abilities: ["political_tab"] } },
  ...
  { id: "quantum_entanglement_command_matrix", name: "Quantum Entanglement Command Matrix", description: "Instant command and communication across imperial distances.", category: "Empire Governance", tier: 3, researchTurns: 3, prerequisites: ["tachyon_communications"], unlocks: { upgrades: ["0 COMM FEE"] } },
  ...
  { id: "empire_control_overlord", name: "Empire Control OVERLORD", description: "Places emergency imperial authority under a single command structure and forms the second half of the gate to Blacklisted Alien Technology.", category: "Empire Governance", tier: 4, researchTurns: 4, prerequisites: ["quantum_entanglement_command_matrix"], isPrimary: true, unlocks: { abilities: ["martial_law"] }, unlockTags: ["blacklisted_gate"] },
...
export { BASE_TURN_SECONDS, RESEARCH_SPEED_TECH_ID, RESEARCH_SPEED_TECH_BONUS, RESEARCH_SPEED_TIERS, totalResearchSpeedBonus, upgradeBonusFromLevel, nextResearchSpeedTier, computeCompletionMs } from "./researchSpeed";
export { RESEARCH_POINTS_TIERS, MAX_RESEARCH_POINTS_LEVEL, researchPointsPerCycle, nextResearchPointsTier } from "./researchPoints";
